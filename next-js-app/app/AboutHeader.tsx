    ...
    <Box as="div" className="h-1/4">
      <Stack>
        ...
        <Track className="gap-4">
          <Link
            href={{
              pathname: `/user/${selectedUser?.firstName}${selectedUser?.lastName}/about`,
              query: selectedUser,
            }}
          >
            <Box
          ...
          <Link
            href={{
              pathname: `/user/${selectedUser?.firstName}${selectedUser?.lastName}/notes`,
              query: selectedUser,
            }}
          >
            <Box as="span" className="text-body-12">
          ...
          <Link
            href={{
              pathname: `/user/${selectedUser?.firstName}${selectedUser?.lastName}/appointments`,
              query: selectedUser,
            }}
          >
            <Box as="span" className="text-body-12">
          ...
          <Link
            href={{
              pathname: `/user/${selectedUser?.firstName}${selectedUser?.lastName}/updates`,
              query: selectedUser,
            }}
          >
            <Box as="span" className="text-body-12">
